...
// get stopped by cop car, cop knows huel so lets go, cop liscense plate has number from earlier a lot
        ...
        System.out.println("Before the Officer even reaches your window you hear him \n" +
                        ...
                        "\" You know- You look all to familiar, you happen to" +
                        ...
                        " car and pulls away infront of you, you note his license plate, \n \"" +
        ...
        System.out.println("Letting yourself in, you finally spot Uncle Huel cradling his "+animal+", Stimpy, On his Sofa.");
                System.out.println("========  Type any Letter and Hit Enter to Continue. ====");
                String e = sc.next();
                System.out.println("You're now very confused because you also notice Stimpy's Urn on the shelf behind him, you remember Stimpy was\n" +
                "ran over by a delivery truck 4 years back. Looking back at the two you now notice that Stimpy's spine seems deformed.\n " +
                ...
                "that you are dead.\" "+firstName+", "+lastName+", date of death: "+date+".1995, at 7:1"+number+"pm. Car found 6 miles west of "+town+", "+region+" \".\n");
